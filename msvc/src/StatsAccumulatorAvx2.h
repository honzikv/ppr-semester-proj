...
/**
 * \brief Manual AVX2 vectorization of StatsAccumulator class
 */
...
public:
	...
	/**
	 * \brief Pushes vector to the object. The process is algorithmically equivalent to StatsAccumulator::push
