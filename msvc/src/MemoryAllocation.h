...
namespace MemoryAllocation {
	...
	constexpr auto DEFAULT_BYTES_PROCESSED_BY_ACCUMULATOR_CPU = 64ULL * 1024 * sizeof(double);
	constexpr auto DEFAULT_BYTES_PROCESSED_BY_ACCUMULATOR_CL = 64ULL * 1024 * sizeof(double);
